 ...
 * createSchema() (e.g. LoginLog, FailedLoginLog), so they don't get the
 * shared .paginate() static and its isDeleted-aware default filter —
 * which would silently match nothing on a model with no isDeleted field.
