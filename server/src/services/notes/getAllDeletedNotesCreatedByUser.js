...
/**
 * Lists soft-deleted notes created by one user, paginated.
 * @param {object} params
 ...
 * @throws {NotFoundError} If this user has no deleted notes.
 */
const getAllDeletedNotesCreatedByUserService = async({
    userId,
    sortOrder = -1,
} = {}) => {
...
export {
    getAllDeletedNotesCreatedByUserService,
}